...
with wget.download(http://www.patentsview.org/data/20171226/claim.tsv.zip) as file:
...
with open('/artifacts/cpc_current.tsv','r') as f:
...
with open('/artifacts/biotech_claims.txt','w') as g:
    with open('/artifacts/claim.tsv','r') as f:
...
documents = doc2vec.TaggedLineDocument('/artifacts/biotech_claims.txt')
